      ...
      <div className="flex justify-center">
        <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input type="submit" value="Actualizar Password" className="bg-indigo-700 px-10 py-3 font-bold text-white rounded-lg uppercase w-full hover:bg-indigo-800 mt-5"/>
          </form>
        </div>
      </div>
    </>
